 ...
 * @version 1.0
 *************************************/
public class AllDialogDemo extends JPanel {
    JLabel label;
 ...
 *返回类型：
 */
    public AllDialogDemo(JFrame frame) {
        ...
        label = new JLabel("点击\"显示\" 按钮显示一个选择的对话框", JLabel.CENTER);
        //放置对象
        ...
        tabbedPane.addTab("简单对话窗", null,frequentPanel,simpleDialogDesc); 
        tabbedPane.addTab("复杂对话窗", null,featurePanel,moreDialogDesc);
        tabbedPane.addTab("图标对话窗", null,iconPanel,iconDesc);
 ...
 */
    protected static ImageIcon createImageIcon(String path) {
        java.net.URL imgURL = AllDialogDemo.class.getResource(path);
        if (imgURL != null) {
 ...
 */
    ...
    public static void main(String[] args) {
        ...
        contentPane.add(new AllDialogDemo(frame));
